...
% Caja de nota editorial (para guiar al estudiante en las partes que debe completar con datos propios)
}
...
\begin{enumerate}[label=\alph*)]
    \item Soy el autor del documento acad\'emico titulado ``Modelo de analítica predictiva espacio-temporal sobre datos abiertos de criminalidad y siniestralidad vial, como apoyo a la planificaci\'on de patrullajes preventivos en Lima Metropolitana''.
...
Modelo de analítica predictiva espacio-temporal sobre datos abiertos de criminalidad y siniestralidad vial, como apoyo a la planificaci\'on de patrullajes preventivos en Lima Metropolitana.
...
\input{cap5_anexos}
\newpage
Con base en la literatura revisada y en el dise\~no propuesto, se plantean las siguientes recomendaciones generales, a complementar con las que se deriven de los resultados espec\'ificos obtenidos:
...
\begin{enumerate}
    ...
    \item \textbf{Desarrollar el sistema conforme a la arquitectura de referencia.} Se recomienda como l\'inea de trabajo futura la implementaci\'on del software (SIG) descrito en la arquitectura de referencia, as\'i como su validaci\'on operativa en una comisar\'ia o municipalidad, contrastando las recomendaciones generadas por el modelo con el criterio experto del personal de patrullaje.
    ...
    \item \textbf{Establecer salvaguardas \'eticas institucionales.} Se recomienda que cualquier adopci\'on institucional del sistema est\'e acompa\~nada de lineamientos expl\'icitos que limiten su uso al nivel agregado espacio-temporal, evitando cualquier forma de perfilamiento individual.
...
\section*{Anexo 1: Diccionario de datos (a completar)}

\section*{Anexo 2: Especificaci\'on de la arquitectura de referencia (a completar)}

\section*{Anexo 3: C\'odigo fuente del an\'alisis o repositorio (a completar)}
