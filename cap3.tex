...
\begin{tabular}{p{4.0cm}p{2.3cm}p{3.0cm}p{2.0cm}p{2.0cm}}
\toprule
...
\begin{axis}[
    ...
    ylabel={Porcentaje de eventos},
    symbolic x coords={22--02,02--06,06--10,10--14,14--18,18--22},
    xtick=data,
...
\addplot[fill=blue!55!black] coordinates {(22--02,25.4) (02--06,5.1) (06--10,12.8) (10--14,15.6) (14--18,17.7) (18--22,23.5)};
\addplot[fill=orange!80!black] coordinates {(22--02,16.9) (02--06,15.7) (06--10,24.1) (10--14,14.3) (14--18,15.2) (18--22,13.8)};
\legend{Denuncias delictivas, Siniestros de tr\'ansito}
\end{axis}
\end{tikzpicture}
\caption[Distribuci\'on horaria de los eventos]{Distribuci\'on porcentual de denuncias delictivas y siniestros de tr\'ansito por franja horaria (julio 2022--junio 2024, Lima Metropolitana). Elaboraci\'on propia.}
\label{fig:franjas}
\end{figure}
...
\setlength{\tabcolsep}{4pt}
\begin{tabular}{p{4.3cm}p{3.4cm}p{4.3cm}}
\toprule
